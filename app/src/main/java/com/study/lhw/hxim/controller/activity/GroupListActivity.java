...
import com.study.lhw.hxim.controller.adapter.GroupListAdapter;
import com.study.lhw.hxim.controller.base.BaseActivity;
import com.study.lhw.hxim.model.Model;
import com.study.lhw.hxim.utils.LogUtils;
    ...
    private void initListener() {
        ...
        lv_grouplist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                LogUtils.e("GroupListActivity", "positon:"+position);
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastUtils.show(GroupListActivity.this, "加载群信息成功!");
//                            groupListAdapter.refresh(mGroups);
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastUtils.show(GroupListActivity.this, "加载群信息失败!");
                        }
                    });
                }
            }
